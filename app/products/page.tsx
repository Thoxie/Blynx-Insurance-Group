...
export const metadata: Metadata = {
  ...
  description:
    "Explore commercial property, personal, life & health, business, and employee benefits solutions from Blynx Insurance Group.",
};
              ...
              >
                <div className="flex flex-col gap-4">
                  <div>
                    ...
                    <p className="mt-2 text-gray-700 leading-relaxed">{c.desc}</p>
                  </div>
