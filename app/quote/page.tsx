...
type BestTime = "Morning" | "Afternoon" | "Evening" | "Anytime" | "Text only";
...
export default function QuotePage() {
  ...
  const [hasPriorDenial, setHasPriorDenial] = useState<
    "Yes" | "No" | "Not sure"
  >("Not sure");

  const [claimsHistory, setClaimsHistory] = useState<
    "None" | "1 claim" | "2–3 claims" | "4+ claims" | "Not sure / prefer not to say"
    ...
    <main className="mx-auto max-w-3xl px-6 py-14">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <label className="grid gap-2">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setContactMethod(
                      e.target.value as "Email" | "Phone" | "Text"
                    )
                  }
                >
      ...
      <section className="mt-6 rounded-2xl border border-gray-200 bg-white p-6">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
            <button
              ...
              className="inline-flex items-center justify-center rounded-xl border border-gray-200 bg-gray-900 px-4 py-2 text-sm font-semibold text-white transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60"
            >
        ...
        <p className="mt-2 text-sm text-gray-600">
          Submit sends your intake to the server (v1 logs in Vercel). Copy is a
          fallback for email/text.
        </p>
...
{summary}
        ...
        {submitStatus === "ok" && (
          <p className="mt-4 rounded-xl border border-gray-200 bg-gray-50 p-3 text-sm text-gray-900">
